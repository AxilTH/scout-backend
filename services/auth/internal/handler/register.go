...
func RegisterHandler(userRepo repository.UserRepository, invitationRepo repository.InvitationRepository, jwtSecret string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Get user's squad IDs (from invitation)
